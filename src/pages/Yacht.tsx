...
const Yacht: React.FC = () => {
  useEffect(() => {
    ...
    document.title = "Race Attack Yacht | Segelyacht TOAD - Oyster 70 | Luxus Charter Kanaren";
  ...
  const galleryImages = [
    {
      ...
      caption: "Die TOAD in voller Fahrt – 260m² Segelfläche am Wind"
    },
    {
      id: 2,
              ...
              <div>
                ...
                >
                  ...
                  <p className="body-lg mb-6">
                    Die TOAD liegt ganzjährig im Südwesten von Gran Canaria. Die Kanaren bieten konstanten Passatwind aus Nordost, milde 26 °C Luft- und über 20 °C Wassertemperatur – ideal von September bis Mai.
                  </p>
                  <ul className="space-y-4 mb-8">
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✓</span>
                      <span>Oyster 70 mit 5 Kabinen, modernster Technik und kompletter Sicherheitsausrüstung</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✓</span>
                      <span>Wöchentliche Törns, Routen nach Wind, Wetter und deinen Wünschen</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✓</span>
                      <span>Bestes Klima von Herbst bis Frühling, kaum Charterverkehr</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✓</span>
                      <span>Mehrere Direktflüge täglich, Transferservice inklusive</span>
                    </li>
                  </ul>
              ...
              {[
                {
                  ...
                  specs: [
                    { label: "Länge / Breite", value: "knapp 22 m / fast 6 m" },
                    { label: "Mast", value: "30 m" },
                    { label: "Segelfläche", value: "ca. 260 m² am Wind, über 300 m² vor dem Wind" }
                  ]
                },
                {
                  category: "Unterkunft",
                  specs: [
                    ...
                    { label: "Sanitär", value: "Jede Kabine mit eigenem WC / Dusche" },
                    { label: "Komfort", value: "Klimaanlage, grosse Küche, Salon mit Panoramafenstern" }
                  ]
                },
                {
                  category: "Ausstattung",
                  specs: [
                    { label: "Antrieb", value: "Starker Hauptmotor + grosser Generator" },
                    { label: "Deck", value: "Komplettes Teakdeck, geschütztes Cockpit, Sonnenliegen" },
                ...
                },
                {
                  category: "Versorgung",
                  specs: [
                    { label: "Kühlung", value: "Grosse Kühl- / Gefrierschränke" },
                ...
                },
                {
                  category: "Sicherheit",
                  specs: [
                    { label: "Rettungsmittel", value: "AIS-Rettungswesten, Rettungsinsel, EPIRB-Notsender" },
                    { label: "Navigation", value: "Radar, UKW / VHF-Funk" },
                    { label: "Medizinisch", value: "Umfangreiche Bordapotheke (Skipper militärisch medizinisch geschult)" }
                  ]
                }
              ].map((section, index) => (
                <motion.div 
              ...
              >
                <div className="bg-black p-8 rounded-lg shadow-lg border border-gold/20">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start">
                      <span className="text-gold mr-3">•</span>
                      <span>Fuerteventura oder, bei längeren Törns, bis La Palma</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">•</span>
                      <span>„Easy Going" von Bucht zu Bucht oder sportlicher Meilentörn – du entscheidest (Anfänger willkommen und auf Wunsch aktiv eingebunden)</span>
                    </li>
                  </ul>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-black p-8 rounded-lg shadow-lg border border-gold/20">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✈</span>
                      <span>Direktflug Zürich → Gran Canaria mit Edelweiss (ca. 4 h, CHF 300–550)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✈</span>
                      <span>Direktflug Basel → Gran Canaria mit EasyJet (ab ca. CHF 300)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold mr-3">✈</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-gold mr-3">🚗</span>
                      <span>Transfer vom Flughafen zur TOAD organisieren wir gern</span>
                    </li>
                  </ul>
                </div>
              </motion.div>
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-2xl italic mb-8 text-gray-200">
                Flexibilität trifft auf Luxus: Wöchentliche Törns, Routen nach Wind, Wetter und deinen Wünschen. Oft hast du die Buchten für dich allein.
              </p>
              <div className="text-gold font-bold">Race Attack Yacht Charter</div>
            </div>
          </div>
        </section>
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-6">
            <div className="bg-gradient-to-r from-black to-black-light p-8 md:p-12 rounded-lg shadow-lg border border-gold/20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="heading-lg mb-6">
                    Bereit, die Leinen <span className="text-gold">loszuwerfen?</span>
                  </h2>
                  <p className="body-lg mb-8">
                    Melde dich für deinen Wunschtermin – wir freuen uns auf dich! Erlebe unvergessliche Segeltörns auf der TOAD in den Gewässern der Kanarischen Inseln.
                  </p>
                ...
                <div className="hidden lg:block">
                  <Marquee direction="right" speed={40} className="py-4">
                    {["Segelyacht", "Oyster 70", "Gran Canaria", "Kanaren", "Charter", "Segeltörn", "Luxus", "TOAD"].map((item, index) => (
